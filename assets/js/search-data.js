...
// Ninja-keys command palette data, rendered once at build time.
//
// Moved out of _includes/scripts/search.liquid so the same payload isn't
// re-emitted inline on every HTML page. Loaded with `defer` — by the time
// this runs the <ninja-keys> element is already in the DOM.
//
// Cache-busted with site.time (build timestamp): the browser caches this
// file for a whole visit, but every redeploy gets a fresh URL.
